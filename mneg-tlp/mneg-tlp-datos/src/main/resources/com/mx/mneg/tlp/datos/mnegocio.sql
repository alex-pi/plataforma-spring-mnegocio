...
--
-- Name: t_ejemplo; Type: TABLE; Schema: public; Owner: pruebas; Tablespace: 
--

CREATE TABLE t_ejemplo (
    id_t_ejemplo bigint NOT NULL,
    c_nombre character varying,
    c_apellido character varying
);


ALTER TABLE public.t_ejemplo OWNER TO pruebas;

--
-- Name: t_ejemplo_seq; Type: SEQUENCE; Schema: public; Owner: pruebas
--

CREATE SEQUENCE t_ejemplo_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER TABLE public.t_ejemplo_seq OWNER TO pruebas;

--
-- Name: t_ejemplo_seq; Type: SEQUENCE SET; Schema: public; Owner: pruebas
--

SELECT pg_catalog.setval('t_ejemplo_seq', 2, true);
...
INSERT INTO acl_class VALUES (1, 'com.mx.mneg.infra.modelo.ModuloMenu');
INSERT INTO acl_class VALUES (2, 'com.mx.mneg.infra.modelo.OpcionMenu');
...
INSERT INTO acl_entry VALUES (7, 3, true, true, true, 1, 1, 2);
INSERT INTO acl_entry VALUES (6, 2, true, true, false, 1, 3, 1);
INSERT INTO acl_entry VALUES (8, 3, true, true, false, 1, 2, 2);
...
--
-- Data for Name: t_ejemplo; Type: TABLE DATA; Schema: public; Owner: pruebas
--

INSERT INTO t_ejemplo VALUES (1, 'Alejandro', 'Pimentel');
...
INSERT INTO t_opcion_menu VALUES (6, 'Módulo 1', 'Módulo 1', NULL, NULL);
INSERT INTO t_opcion_menu VALUES (10, 'Módulo 2', 'Módulo 2', NULL, NULL);
INSERT INTO t_opcion_menu VALUES (11, 'Módulo 3', 'Módulo 3', NULL, NULL);
INSERT INTO t_opcion_menu VALUES (1, 'Opción 1.1', 'Opción 1.1', NULL, 1);
...
INSERT INTO t_usuario_seguridad VALUES (2, 'usain', 'bolt', 'Usain Bolt', true);
INSERT INTO t_usuario_seguridad VALUES (3, 'pepe', 'pepe', 'Pepe el Toro', true);
...
--
-- Name: t_ejemplo_pkey; Type: CONSTRAINT; Schema: public; Owner: pruebas; Tablespace: 
--

ALTER TABLE ONLY t_ejemplo
    ADD CONSTRAINT t_ejemplo_pkey PRIMARY KEY (id_t_ejemplo);
